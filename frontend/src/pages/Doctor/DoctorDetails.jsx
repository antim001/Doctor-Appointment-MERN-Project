...
import doctor from '../../assets/image/doctor-img03.png'
const DoctorDetails = () => {
...
<div className='md:col-span-2'>
  <div className='flex items-center gap-5'>
   ...
   <h3 className='text-[22px] leading-9 mt-3 font-bold'>Antim Sarker</h3>
   ...
   <p className='text__para text-[14px] md:text-[15px] leading-5 lg:max-w-[390px]'>Lorem ipsum dolor sit amet, consectetur a
