...
<div className='text-center mt-4'>
  <h3 className='text-[18px] leading-[30px] font-bold'>Antim Sarker</h3>
  <p className=' text-[15px] leading-6 font-medium'>antimsarker0@gmail.com</p>
  <p className=' text-[15px] leading-6 font-medium'>
   Blood Type:<span className='ml-2 text-[22px] leading-8'>o+</span>
    </p>
</div>
